...
if __name__ == "__main__":
	...
	parser.add_argument("--env", default="MountainCar-v0")            # OpenAI gym environment name  # Change Name if you play other gym Env. "MountainCar-v0", "CartPole-v0"
	parser.add_argument("--seed", default=0, type=int)             # Sets Gym, PyTorch and Numpy seeds
	parser.add_argument("--buffer_name", default="Default")        # Prepends name to filename
	parser.add_argument("--max_timesteps", default=2e5, type=int)  # Max time steps to run environment or train for   # for cartpole default=5e4, for mountain car 2e5
