...
class MountainCarEnv(gym.Env):
    ...
    def __init__(self, goal_velocity=0):
        ...
        self._max_episode_steps = 10000 # added from cartpole
        self._steps = 0 # added from cartpole
        ...
        self.force = 0.001
        self.gravity = 0.0025      # default value :  0.0025
    ...
    def step(self, action):
        ...
        if (position == self.min_position and velocity < 0):
            ...
            (position >= self.goal_position and velocity >= self.goal_velocity) or self._steps >= self._max_episode_steps  # modified like cartpole
        )
        reward = -1.0
